...
const statusOrder = ["in_progress", "todo", "backlog", "in_review", "needs_revision", "blocked", "done", "cancelled"];
...
const quickFilterPresets = [
  ...
  { label: "Active", statuses: ["todo", "in_progress", "in_review", "needs_revision", "blocked"] },
